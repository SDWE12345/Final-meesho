...
const Payments = () => {
  ...
  useEffect(() => {
    ...
    switch (activeTab) {
      case 4:
        setPayment(
          `paytmmp://pay?pa=${upiId}&pn=Online%20Shopping&am=${amount}&cu=INR&url=&mode=02&orgid=159012&mid=&msid=&mtid=&sign=MEQCIB4NcyZl2FEuktegagtryRG1iA1XG9r3tMHCIGZmR0wQAiBPvbuBFfhZjmq3MKMKH/XouOPk2+STl/VwYQTg2Y7vWg==`
        );
        break;
      case 1:
        setPayment(
